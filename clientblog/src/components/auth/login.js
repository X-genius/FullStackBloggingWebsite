    ...
    return(
          ...
          <Helmet>
            ...
            <div className = "row mt-65">
                 <div className = "col-8">
                     <BgImage/>
                     <Toaster position="top-right" reverseOrder={false} toastOptions={{style: {fontSize : "15px"}}}/>
                  </div>
                   ...
                   <div className = "account">
                     <div className = "account__section">
                       ...
                       <div className = "group">
                         ...
                         <div className = "group">
                           <input type = "password" name = "password" value = {state.password} onChange = {handleInputs} className = "group__control" placeholder = "Enter Password"/>
                         </div>
